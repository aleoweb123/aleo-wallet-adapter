				...
				<div className='wallet-adapter-modal-container'>
					<div className='wallet-adapter-modal-wrapper'>
						...
						{installedWallets.length ? (
							<>
								...
								<ul className='wallet-adapter-modal-list'>
									{installedWallets.map((wallet) => (
										<WalletListItem key={wallet.adapter.name} handleClick={(event) => handleWalletClick(event, wallet.adapter.name)} wallet={wallet} />
									))}
									{otherWallets.length ? (
							...
							<>
								<h1 className='wallet-adapter-modal-title'>You'll need a wallet on Aleo to continue</h1>
